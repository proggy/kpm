...
def _std_many(numpy.ndarray[double, mode='c']         moments,
    ...
    given datatype."""
    __created__ = '2013-05-31'
    __modified__ = '2013-05-31'
    # based on tb.kpm2.rcstr._std (2012-08-20)
...
def _std_real_many(numpy.ndarray[double, mode='c']         moments,
    ...
    __created__ = '2013-05-31'
    __modified__ = '2013-05-31'
    # based on tb.kpm2.rcstr._std_real (2012-08-20 until 2012-10-09)
...
def _std_real_omp_many(numpy.ndarray[double, mode='c']         moments,
    ...
    __modified__ = '2013-06-01'
    # based on tb.kpm2.rcstr._std_real_many (2013-05-31)
...
def _std_complex_omp_many(numpy.ndarray[complex, mode='c']         moments,
    ...
    __created__ = '2013-06-01'
    __modified__ = '2013-06-01'
    # based on tb.kpm2.rcstr._std_complex_many (2013-06-01)
