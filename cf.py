...
@Frog(inmap=dict(mat='$0/scell'), outmap={0: '$0/ldos'},
...
@Frog(inmap=dict(scell='$0/scell', init='$0/aldos'), outmap={0: '$0/aldos'},
      shortopts=kpm.shortopts, longopts=kpm.longopts,
...
@Frog(inmap=dict(scell='$0/scell', init='$0/gldos'), outmap={0: '$0/gldos'},
      shortopts=kpm.shortopts, longopts=kpm.longopts,
      opttypes=kpm.opttypes, optdoc=kpm.optdoc, overwrite=True)
...
@Frog(inmap=dict(scell='$0/scell', ainit='$0/aldos', ginit='$0/gldos'),
...
@Frog(inmap=dict(mat='$0/scell'), outmap={0: '$0/dos'},
      preproc=dict(mat=lambda scell: scell.tbmat(format='csr')),
      shortopts=kpm.shortopts, longopts=kpm.longopts,
      opttypes=kpm.opttypes, optdoc=kpm.optdoc)
...
@Frog(inmap=dict(scell='$0/scell', init='$0/ados'), outmap={0: '$0/ados'},
      shortopts=kpm.shortopts, longopts=kpm.longopts,
      opttypes=kpm.opttypes, optdoc=kpm.optdoc, overwrite=True)
